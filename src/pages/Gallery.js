...
function Gallery() {
  ...
  return (
    <div className="Gallery">
      ...
      {/* Add Image Section */}
      <section className="dark:bg-dark-background text-light-text dark:text-dark-text p-8 text-center">
        <h2 className="text-3xl font-semibold mb-4">Add Your Own Image</h2>
        <input
          type="file"
          accept="image/*"
          onChange={handleFileChange}
          className="bg-light-background dark:bg-gray-800 pl-4 py-2 rounded cursor-pointer"
        />
      </section>

      {/* Gallery Section */}
      <section className="dark:bg-dark-background text-light-text dark:text-dark-text p-8">
